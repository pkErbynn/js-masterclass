/////// This file consists of the model-view-controller all combined
...
// loading spinner
const renderLoadingSpinner = function (parentElment) {
  const markup = `
    <div class="spinner">
      <svg>
...
const showRecipe = async function () {
  ...
  try {
    ...
    recipeContainer.innerHTML = ''; // empty container before inserting new markup
