...
class RecipeView extends View {
    ...
    _errorMessage = "We couldn't find the matching recipe";
    _sucessMessage = "success";
    ...
    _generateMakupIngredient(ingredient){
        return `
            <li class="recipe__ingredient">
                <svg class="recipe__icon">
                    <use href="${icons}#icon-check"></use>
...
export default new RecipeView();    // create the object here and export because the controller should only consume